...
% DOBBIAMO DECIDERE COSA FARE PER I VALORI NEGATIVI DELLE TABELLE: O LI METTIAMO TUTTI NEGATIVI O VA SPECIFICATO CHE LI STIAMO PLOTTANDO CON IL SEGNO OPPOSTO COSì CHE VENGA TUTTO NEL PRIMO QUADRANTE PIUTTOSTO CHE NEL QUARTO. Io metterei tutti i dati negativi, perchè tanto lo spiego dopo che il grafico va nel primo quadrante.
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.6\textwidth]{Grafico totale.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\textwidth]{Fit-200.png}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=0.8\textwidth]{Fit-100.png}
...
% DA METTERE: calcolo dei parametri a b g e beta + confronto con valori aspettati + spiegazione effetto Early.
